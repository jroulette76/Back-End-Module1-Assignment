...
describe("GET /api/v1/portfolio/performance - invalid input", () => {
    it("should return 400 when query parameters are not numbers", async () => {
        // Arrange
        const initialInvestment = "abc";
        const currentValue = "def";
        ...
        expect(response.body.error).toBe("initialInvestment and currentValue must be valid numbers.");
    });
});